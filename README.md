...
to discover. I used the dataset available here for training and testing. If you're 
interested in the inner workings, you can dive into the model's details through the 
notebook on Kaggle. And if you'd like to give it a try yourself, you can download the 'APP' 
